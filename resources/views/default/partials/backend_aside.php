    ...
    <div class="aside-content">
        ...
        <div class="aside-menu overflow-hidden">
            ...
            <nav id="stacked-menu" class="stacked-menu stacked-menu-has-collapsible">
                ...
                <ul class="menu">
                    <!-- .menu-item -->
                    <li class="menu-item<?php if ($page == 'account') {
                                            echo ' has-active';
                                        }
                                        ?>">
                    ...
                    ?>
                    <li class="menu-item has-child<?php if (in_array($page, $member_menu)) {
                                                        echo ' has-active';
                                                    }
                                                    ?>">
                    ...
                    <!-- .menu-item -->
                    <li class="menu-item<?php if ($page == 'account-stores' || substr($page, 0, 14) == 'account-stripe') {
                                            echo ' has-active';
                                        }
                                        ?>">
                    ...
                    <li class="menu-item has-child<?php if (in_array($page, $inventory_menu)) {
                        ...
                        <ul class="menu">
                            ...
                            <li class="menu-item<?php if ($page == 'inventory-defaults') {
                                                    echo ' has-active';
                                                }
                                                ?>">
